                            ...
                            <ul class="nk-menu nk-menu-main ui-s2">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li >
                                            <a class="nk-menu-link" @if(session('user_poste')->nom === 'pro') href="{{ route('index_evaluation_processus') }}" @else href="#" @endif >
                                                {{-- {{ route('index_evaluation_processus') }} --}}
                                                <span class="nk-menu-icon" >
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        {{-- <li >
                                            <a class="nk-menu-link" @if(session('user_poste')->nom === 'pro') href="{{ route('index_validation_risque') }}" @else href="#" @endif>
                                                <span class="nk-menu-icon" >
                                                    <em class="icon ni ni-view-list-sq"></em>
                                                </span>
                                                <span class="nk-menu-text">
                ...
                <div class="container-fluid">
                    <div class="nk-footer-wrap">
                        <div class="nk-footer-copyright">
                            ...
                            <span><img height="30" width="30" src="{{ asset('images/logo.png') }}" alt="" class="me-5"></span>
