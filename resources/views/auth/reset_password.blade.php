                                ...
                                <div id="cadre_email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-md" id="email" name="email" placeholder="Entrer votre Email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <button id="btn_email" class="btn btn-md btn-primary btn-dim btn-block">
