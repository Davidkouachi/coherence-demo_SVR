                                ...
                                <form id="login" action="/auth_user" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap ">
                                            <input type="email" class="form-control form-control-md" id="email" name="email" value="{{ old('email') }}" placeholder="Entrer votre email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-md btn-success btn-block">Connexion</button>
                                    </div>
                                </form>
