...
<div class="nk-content-body">
    <div class="nk-block-head">
        <div class="nk-block-between g-3">
            ...
            <div class="nk-block-head-content">
                <a href="{{ route('index_ac') }}" class="btn btn-danger btn-outline-white d-none d-sm-inline-flex">
                    <em class="icon ni ni-arrow-left"></em>
                    <span>Retour</span>
                </a>
                <a href="{{ route('index_ac') }}" class="btn btn-danger btn-outline-white d-inline-flex d-sm-none">
                    <em class="icon ni ni-arrow-left"></em>
                </a>
            </div>
        </div>
                ...
                <div class="col-lg-12 col-xxl-12" style="margin-top: +2px;">
                    <div class="card" style="background: transparent;">
                        <div class="card-inner text-center">
                            <img src="{{asset('images/logo.png')}}" height="100" width="120">
                        </div>
                    </div>
                </div>
